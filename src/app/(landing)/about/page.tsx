    ...
    <div className="py-12 md:py-20 space-y-12">
      <section className="text-center animate-fade-in">
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-foreground">
          Acerca de <span className="text-primary">{schoolName}</span>
        </h1>
        <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto">
          Somos {schoolName}, una institución comprometida con la excelencia educativa y el desarrollo integral de nuestros estudiantes. Creemos en el poder de la educación para transformar vidas y construir un futuro mejor.
        </p>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-12 items-center animate-fade-in" style={{ animationDelay: '200ms' }}>
        ...
        <div className="relative h-80 md:h-96 rounded-xl shadow-xl overflow-hidden group">
          <Image
            src={aboutImg}
            alt={`Instalaciones de ${schoolName}`}
            fill
